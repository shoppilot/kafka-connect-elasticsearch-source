...
## Installation:
  ...
  Download (https://github.com/NGL91/kafka-connect-elasticsearch-source/raw/master/target/elastic-source-connect-0.3-jar-with-dependencies.jar) the jar and put into the connect classpath (e.g ``/usr/share/java/kafka-connect-elasticsearch`` ) or set ``plugin.path`` parameter appropriately.
